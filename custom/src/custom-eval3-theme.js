...
/**
 * `CustomEval3Theme`
 * `CustomEval3Theme based on modern flex design system`
 ...
 * @element custom-eval3-theme
 */
class CustomEval3Theme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomEval3Theme.tag, CustomEval3Theme);
export { CustomEval3Theme };
